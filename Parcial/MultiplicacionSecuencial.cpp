...
void multiplicarMatrices(int **matrix1, int **matrix2, int **result, int num_rows, int num_cols, int COMM);
...
int main(int argc, const char** argv){
    ...
    if(num_cols1 == num_rows2){
        ...
        multiplicarMatrices(matrix1, matrix2, result, num_rows1, num_cols2, num_cols1);
